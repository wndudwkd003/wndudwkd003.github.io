        ...
        <article className="border rounded-lg p-4 mb-4">
            ...
            <div className="flex flex-wrap gap-1 mb-2">
                {project.tags.map((tag) => (
                    <span key={tag} className="text-xs border rounded-full px-2 py-0.5 text-gray-700">
                        {tag}
                    </span>
                ))}
            </div>
            ...
            {project.links && (
                <div className="flex gap-3 text-xs">
                    {project.links.github && (
                        <a href={project.links.github} target="_blank" rel="noreferrer" className="underline">
                            GitHub
                        </a>
                    )}
                    {project.links.paper && project.links.paper !== "" && (
                        <a href={project.links.paper} target="_blank" rel="noreferrer" className="underline">
                            Paper
                        </a>
                    )}
                    {project.links.demo && project.links.demo !== "" && (
                        <a href={project.links.demo} target="_blank" rel="noreferrer" className="underline">
                            Demo
                        </a>
                    )}
                </div>
